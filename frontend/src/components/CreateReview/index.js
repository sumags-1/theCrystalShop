        ...
        <div class="w-1/3">
            <form onSubmit={handleSubmit}>
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input required class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-fit py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-black" type="text" id="title" placeholder="Title of Review" onChange={handleChange} value={formState.title || ''} required />
                    </div>
                </div>
